...
public:
    ...
    void options(std::uint32_t transients, double formant_scale, double envelope_ms) noexcept {
        transients_ = transients != 0; mixed_ = transients == 2;
        formant_scale_ = formant_scale; envelope_.configure(envelope_ms);
    }
